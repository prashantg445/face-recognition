...
names=[]
os.chdir('/home/prashant/projects/face_recog/all_faces')  #to collect all names
...
while True:
	...
	if ret == True:
		...
		for (x,y,w,h) in faces:
			...
			cv2.putText(fr, text, (x, y), font, 1, (255, 255, 0), 2)  #for showing name of recognized person
